...
<head>
    ...
    <link href="{{ asset('/css/patternfly.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('/css/patternfly-additions.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <nav class="navbar navbar-pf-vertical">
        <div class="navbar-header">
            ...
            <a href="/" class="navbar-brand">
                <img class="navbar-brand-icon" src="{{ asset('/img/logo-alt.svg') }}" alt=""/>
                <img class="navbar-brand-name" src="{{ asset('/img/brand-alt.svg') }}" alt="PatternFly Enterprise Application" />
            </a>
        </div>
